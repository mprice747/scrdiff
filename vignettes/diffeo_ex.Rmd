...
-   **num_cores** - "ALL" or positive integer, number of cores to be used for parallelization, if "ALL", use all cores available
...
cov_scale <- 0.63 
apply_sm_correction <- TRUE # Filter out low posterior modes
num_cores <- 2 # 2 for vignette, highly recommend to use ALL available (num_cores <- "ALL")
